...
export declare class ExtensionStore extends EventEmitter {
    ...
    getLastFocusedWindow(): BrowserWindow | null | undefined;
    getCurrentWindow(): BrowserWindow | null | undefined;
    addWindow(window: Electron.BrowserWindow): void;
    createWindow(event: ExtensionEvent, details: chrome.windows.CreateData): Promise<BrowserWindow>;
